...
//        Log.e("errorwe",storage.getReference("사건폴더").toString())
        ...
        db = FirebaseDatabase.getInstance("https://jutaek.firebaseio.com/").reference
...
//            Log.e("error","error발생")
        ...
        rv.adapter = ProfileAdapter2(listItemList)
    ...
    var searchViewTextListener: SearchView.OnQueryTextListener =
        object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(s: String): Boolean {
                rv.adapter = profileadapter2
                profileadapter2.getFilter().filter(s)
...
//        rv.layoutManager = LinearLayoutManager(this)
        ...
        profileadapter2 = ProfileAdapter2(listItemList)
        rv.adapter = profileadapter2
    }
    // 화면 터치 막기
