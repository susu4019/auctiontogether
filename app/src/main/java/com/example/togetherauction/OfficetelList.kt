...
class OfficetelList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_officetel_list)
...
//        Log.e("errorwe",storage.getReference("사건폴더").toString())
        ...
        db = FirebaseDatabase.getInstance("https://officetel.firebaseio.com/").reference
            ...
            db.addValueEventListener(object :
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for (model in 0 until totalcount){
                        ...
                        listItemList.add(vo)
                        Log.d("lowPrce", listItemList[model].lowPrice)
                    }
...
//            Log.e("error","error발생")
        ...
        rv.adapter = ProfileAdapter3(listItemList)
    ...
    var searchViewTextListener: SearchView.OnQueryTextListener =
        object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(s: String): Boolean {
                rv.adapter = profileadapter3
                profileadapter3.getFilter().filter(s)
...
//        rv.layoutManager = LinearLayoutManager(this)
        ...
        profileadapter3 = ProfileAdapter3(listItemList)
        rv.adapter = profileadapter3
    }
    // 화면 터치 막기
