...
class ProfileAdapter (val listItemList : ArrayList<listItemVO>) : RecyclerView.Adapter<ProfileAdapter.CustomViewHolder>(),Filterable
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileAdapter.CustomViewHolder {
        ...
        return CustomViewHolder(view).apply{
            itemView.setOnClickListener {
                ...
                val intent = Intent(context, ApartmentDetail::class.java)
...
//        }
    ...
    inner class ItemFilter : Filter() {
        override fun performFiltering(charSequence: CharSequence): FilterResults {
            ...
            var filteredList = ArrayList<listItemVO>()
        ...
        override fun publishResults(charSequence: CharSequence?, filteResults: FilterResults) {
            ...
            listItemList.clear()
            listItemList.addAll(filteResults.values as ArrayList<listItemVO>)
