...
class ProfileAdapter4 (val listItemList : ArrayList<listItemVO>) : RecyclerView.Adapter<ProfileAdapter4.CustomViewHolder>(),Filterable
...
//    var mAccounts:MutableList<listItemVO> = accounts as MutableList<listItemVO>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileAdapter4.CustomViewHolder {
        context = parent.context
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_item4, parent, false)
        return CustomViewHolder(view).apply{
            itemView.setOnClickListener {
                val curPos : Int = adapterPosition
                val intent = Intent(context, FranchiseDetail::class.java)
