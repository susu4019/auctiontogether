...
class ApartmentList : AppCompatActivity() {
    object Sortbydate: Comparator<listItemVO>{
        fun rp(txt1 : String): Int{
        ...
        override fun compare(o1: listItemVO?, o2: listItemVO?): Int {
            return rp(o1!!.sellDate)!!.compareTo(rp(o2!!.sellDate))
        }
    }
    ...
    var listItemListCopy = listItemList
...
//            Log.e("error","error발생")
        ...
        low_gray.setOnClickListener {
            ...
            if(isChecked==0){
                ...
                listItemList.apply{this.sortWith(SortbyLow)}
                isChecked +=1
                isChecked2 =0
                isChecked3 =0
                isChecked4 =0
        ...
        gp_gray.setOnClickListener {
            ...
            if(isChecked2==0){
                ...
                date_gray.setBackgroundResource(R.drawable.date_gray)
                yuchal_gray.setBackgroundResource(R.drawable.yuchal_gray)
                listItemList.apply{this.sortWith(Sortbygp)}
                isChecked ==0
                isChecked2  +=1
                isChecked3 ==0
                isChecked4 ==0
        ...
        date_gray.setOnClickListener {
            rv.adapter?.notifyDataSetChanged()
            if(isChecked3==0){
                listItemList.apply{this.sortWith(Sortbydate)}
                low_gray.setBackgroundResource(R.drawable.low_gray)
                gp_gray.setBackgroundResource(R.drawable.gp_gray)
        ...
        yuchal_gray.setOnClickListener {
            rv.adapter?.notifyDataSetChanged()
            if(isChecked4==0){
                listItemList.apply{this.sortWith(Sortbyyu)}
                low_gray.setBackgroundResource(R.drawable.low_gray)
                gp_gray.setBackgroundResource(R.drawable.gp_gray)
                date_gray.setBackgroundResource(R.drawable.date_gray)
        ...
        rv.adapter = ProfileAdapter(listItemList)
...
//        rv.layoutManager = LinearLayoutManager(this)
        profileadapter = ProfileAdapter(listItemList)
        rv.adapter = profileadapter
    }
    // 화면 터치 막기
